export declare type ImageResolveResult = string | {
    path: string;
};
export declare type ImageResolver = (name: string) => ImageResolveResult | null | undefined | void;
export declare type Transformer = (code: string, id: string, path: string, query: Record<string, string>) => string;
/**
 * Plugin options.
 */
...
export declare type ImagesImportMap = Record<string, string[] | undefined>;
