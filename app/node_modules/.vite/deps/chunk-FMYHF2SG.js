...
function x() {
  var n2, u3, t3, o2, r3, e3, c3, s3, a3;
  for (i.sort(f); n2 = i.shift(); )
    n2.__d && (u3 = i.length, o2 = void 0, e3 = (r3 = (t3 = n2).__v).__e, s3 = [], a3 = [], (c3 = t3.__P) && ((o2 = v({}, r3)).__v = r3.__v + 1, l.vnode && l.vnode(o2), L(c3, o2, r3, t3.__n, void 0 !== c3.ownerSVGElement, 32 & r3.__u ? [e3] : null, s3, null == e3 ? m(r3) : e3, !!(32 & r3.__u), a3), o2.__.__k[o2.__i] = o2, M(s3, o2, a3), o2.__e != e3 && k(o2)), i.length > u3 && i.sort(f));
  x.__r = 0;
}
function C(n2, l3, u3, t3, i3, o2, r3, f3, e3, a3, h3) {
  var v3, p3, y3, d2, _3, g4 = t3 && t3.__k || s, b3 = l3.length;
  for (u3.__d = e3, P(u3, l3, g4), e3 = u3.__d, v3 = 0; v3 < b3; v3++)
    null != (y3 = u3.__k[v3]) && "boolean" != typeof y3 && "function" != typeof y3 && (p3 = -1 === y3.__i ? c : g4[y3.__i] || c, y3.__i = v3, L(n2, y3, p3, i3, o2, r3, f3, e3, a3, h3), d2 = y3.__e, y3.ref && p3.ref != y3.ref && (p3.ref && z(p3.ref, null, y3), h3.push(y3.ref, y3.__c || d2, y3)), null == _3 && null != d2 && (_3 = d2), 65536 & y3.__u || p3.__k === y3.__k ? e3 = S(y3, e3, n2) : "function" == typeof y3.type && void 0 !== y3.__d ? e3 = y3.__d : d2 && (e3 = d2.nextSibling), y3.__d = void 0, y3.__u &= -196609);
  u3.__d = e3, u3.__e = _3;
}
function P(n2, l3, u3) {
  var t3, i3, o2, r3, f3, e3 = l3.length, c3 = u3.length, s3 = c3, a3 = 0;
  for (n2.__k = [], t3 = 0; t3 < e3; t3++)
    null != (i3 = n2.__k[t3] = null == (i3 = l3[t3]) || "boolean" == typeof i3 || "function" == typeof i3 ? null : "string" == typeof i3 || "number" == typeof i3 || "bigint" == typeof i3 || i3.constructor == String ? d(null, i3, null, null, i3) : h(i3) ? d(g, { children: i3 }, null, null, null) : void 0 === i3.constructor && i3.__b > 0 ? d(i3.type, i3.props, i3.key, i3.ref ? i3.ref : null, i3.__v) : i3) ? (i3.__ = n2, i3.__b = n2.__b + 1, f3 = H(i3, u3, r3 = t3 + a3, s3), i3.__i = f3, o2 = null, -1 !== f3 && (s3--, (o2 = u3[f3]) && (o2.__u |= 131072)), null == o2 || null === o2.__v ? (-1 == f3 && a3--, "function" != typeof i3.type && (i3.__u |= 65536)) : f3 !== r3 && (f3 === r3 + 1 ? a3++ : f3 > r3 ? s3 > e3 - r3 ? a3 += f3 - r3 : a3-- : a3 = f3 < r3 && f3 == r3 - 1 ? f3 - r3 : 0, f3 !== t3 + a3 && (i3.__u |= 65536))) : (o2 = u3[t3]) && null == o2.key && o2.__e && (o2.__e == n2.__d && (n2.__d = m(o2)), N(o2, o2, false), u3[t3] = null, s3--);
  if (s3)
    for (t3 = 0; t3 < c3; t3++)
      null != (o2 = u3[t3]) && 0 == (131072 & o2.__u) && (o2.__e == n2.__d && (n2.__d = m(o2)), N(o2, o2));
}
function S(n2, l3, u3) {
  var t3, i3;
...
function H(n2, l3, u3, t3) {
  ...
  if (t3 > (null != e3 && 0 == (131072 & e3.__u) ? 1 : 0))
    for (; r3 >= 0 || f3 < l3.length; ) {
      if (r3 >= 0) {
        if ((e3 = l3[r3]) && 0 == (131072 & e3.__u) && i3 == e3.key && o2 === e3.type)
          return r3;
        r3--;
      }
      if (f3 < l3.length) {
        if ((e3 = l3[f3]) && 0 == (131072 & e3.__u) && i3 == e3.key && o2 === e3.type)
          return f3;
        f3++;
      }
    }
...
function T(n2, l3, u3, t3, i3) {
  ...
  n:
    if ("style" === l3)
      ...
      o2 = l3 !== (l3 = l3.replace(/(PointerCapture)$|Capture$/, "$1")), l3 = l3.toLowerCase() in n2 ? l3.toLowerCase().slice(2) : l3.slice(2), n2.l || (n2.l = {}), n2.l[l3 + o2] = u3, u3 ? t3 ? u3.u = t3.u : (u3.u = Date.now(), n2.addEventListener(l3, o2 ? D : A, o2)) : n2.removeEventListener(l3, o2 ? D : A, o2);
    else {
      if (i3)
...
function L(n2, u3, t3, i3, o2, r3, f3, e3, c3, s3) {
  var a3, p3, y3, d2, _3, m3, k3, w3, x4, P3, S2, $3, H3, I3, T4, A3 = u3.type;
    ...
    if ("function" == typeof A3)
      try {
        if (w3 = u3.props, x4 = (a3 = A3.contextType) && i3[a3.__c], P3 = a3 ? x4 ? x4.props.value : a3.__ : i3, t3.__c ? k3 = (p3 = u3.__c = t3.__c).__ = p3.__E : ("prototype" in A3 && A3.prototype.render ? u3.__c = p3 = new A3(w3, P3) : (u3.__c = p3 = new b(w3, P3), p3.constructor = A3, p3.render = O), x4 && x4.sub(p3), p3.props = w3, p3.state || (p3.state = {}), p3.context = P3, p3.__n = i3, y3 = p3.__d = true, p3.__h = [], p3._sb = []), null == p3.__s && (p3.__s = p3.state), null != A3.getDerivedStateFromProps && (p3.__s == p3.state && (p3.__s = v({}, p3.__s)), v(p3.__s, A3.getDerivedStateFromProps(w3, p3.__s))), d2 = p3.props, _3 = p3.state, p3.__v = u3, y3)
          ...
          if (null == A3.getDerivedStateFromProps && w3 !== d2 && null != p3.componentWillReceiveProps && p3.componentWillReceiveProps(w3, P3), !p3.__e && (null != p3.shouldComponentUpdate && false === p3.shouldComponentUpdate(w3, p3.__s, P3) || u3.__v === t3.__v)) {
          ...
          null != p3.componentWillUpdate && p3.componentWillUpdate(w3, p3.__s, P3), null != p3.componentDidUpdate && p3.__h.push(function() {
            p3.componentDidUpdate(d2, _3, m3);
          });
        }
        ...
        p3.state = p3.__s, null != p3.getChildContext && (i3 = v(v({}, i3), p3.getChildContext())), y3 || null == p3.getSnapshotBeforeUpdate || (m3 = p3.getSnapshotBeforeUpdate(d2, _3)), C(n2, h(T4 = null != a3 && a3.type === g && null == a3.key ? a3.props.children : a3) ? T4 : [T4], u3, t3, i3, o2, r3, f3, e3, c3, s3), p3.base = u3.__e, u3.__u &= -161, p3.__h.length && f3.push(p3), k3 && (p3.__E = p3.__ = null);
      } catch (n3) {
        u3.__v = null, c3 || null != r3 ? (u3.__e = e3, u3.__u |= c3 ? 160 : 32, r3[r3.indexOf(e3)] = null) : (u3.__e = t3.__e, u3.__k = t3.__k), l.__e(n3, u3, t3);
      }
    else
      null == r3 && u3.__v === t3.__v ? (u3.__k = t3.__k, u3.__e = t3.__e) : u3.__e = j(t3.__e, u3, t3, i3, o2, r3, f3, c3, s3);
  (a3 = l.diffed) && a3(u3);
}
function M(n2, u3, t3) {
  u3.__d = void 0;
...
function j(l3, u3, t3, i3, o2, r3, f3, e3, s3) {
  var a3, v3, y3, d2, _3, g4, b3, k3 = t3.props, w3 = u3.props, x4 = u3.type;
  if ("svg" === x4 && (o2 = true), null != r3) {
  ...
  if (null == l3) {
    ...
    l3 = o2 ? document.createElementNS("http://www.w3.org/2000/svg", x4) : document.createElement(x4, w3.is && w3), r3 = null, e3 = false;
  }
  if (null === x4)
    ...
    for (a3 in k3)
      _3 = k3[a3], "children" == a3 || ("dangerouslySetInnerHTML" == a3 ? y3 = _3 : "key" === a3 || a3 in w3 || T(l3, a3, null, _3, o2));
    for (a3 in w3)
      _3 = w3[a3], "children" == a3 ? d2 = _3 : "dangerouslySetInnerHTML" == a3 ? v3 = _3 : "value" == a3 ? g4 = _3 : "checked" == a3 ? b3 = _3 : "key" === a3 || e3 && "function" != typeof _3 || k3[a3] === _3 || T(l3, a3, _3, k3[a3], o2);
    if (v3)
      e3 || y3 && (v3.__html === y3.__html || v3.__html === l3.innerHTML) || (l3.innerHTML = v3.__html), u3.__k = [];
    else if (y3 && (l3.innerHTML = ""), C(l3, h(d2) ? d2 : [d2], u3, t3, i3, o2 && "foreignObject" !== x4, r3, f3, r3 ? r3[0] : t3.__k && m(t3, 0), e3, s3), null != r3)
      for (a3 = r3.length; a3--; )
        null != r3[a3] && p(r3[a3]);
...
function N(n2, u3, t3) {
  ...
  if (i3 = n2.__k)
    for (o2 = 0; o2 < i3.length; o2++)
      i3[o2] && N(i3[o2], u3, t3 || "function" != typeof n2.type);
...
function q(u3, t3, i3) {
  var o2, r3, f3, e3;
  l.__ && l.__(u3, t3), r3 = (o2 = "function" == typeof i3) ? null : i3 && i3.__k || t3.__k, f3 = [], e3 = [], L(t3, u3 = (!o2 && i3 || t3).__k = y(g, null, [u3]), r3 || c, c, void 0 !== t3.ownerSVGElement, !o2 && i3 ? [i3] : r3 ? null : t3.firstChild ? n.call(t3.childNodes) : null, f3, !o2 && i3 ? i3 : r3 ? r3.__e : t3.firstChild, o2, e3), M(f3, u3, e3);
}
function F(n2, l3) {
...
l.unmount = function(n2) {
  ...
  if (this.__b) {
    if (this.__v.__k) {
      ...
      this.__v.__k[0] = F3(this.__b, r3, o2.__O = o2.__P);
    }
    this.__b = null;
  }
...
l.vnode = function(n2) {
  "string" == typeof n2.type && function(n3) {
    ...
    for (var o2 in t3) {
      var i3 = t3[o2];
      if (!("value" === o2 && "defaultValue" in t3 && null == i3 || Y && "children" === o2 && "noscript" === e3 || "class" === o2 || "className" === o2)) {
        var l3 = o2.toLowerCase();
        "defaultValue" === o2 && "value" in t3 && null == t3.value ? o2 = "value" : "download" === o2 && true === i3 ? i3 = "" : "ondoubleclick" === l3 ? o2 = "ondblclick" : "onchange" !== l3 || "input" !== e3 && "textarea" !== e3 || $2(t3.type) ? "onfocus" === l3 ? o2 = "onfocusin" : "onblur" === l3 ? o2 = "onfocusout" : H2.test(o2) ? o2 = l3 : -1 === e3.indexOf("-") && B2.test(o2) ? o2 = o2.replace(Z, "-$&").toLowerCase() : null === i3 && (i3 = void 0) : l3 = o2 = "oninput", "oninput" === l3 && u3[o2 = l3] && (o2 = "oninputCapture"), u3[o2] = i3;
      }
    }
...
function flushSync(runBeforeFlush) {
  ...
  q(y(FakeComponent, {}), document.createElement("div"));
  while (callbackQ.length) {
    callbackQ.shift()();
  }
  l.debounceRendering = oldDebounceRendering;
}
var FakeComponent = class extends b {
  render() {
    return y("div", {});
  }
  componentDidMount() {
...
function createContext(defaultValue) {
  let ContextType = F(defaultValue);
...
var PureComponent = class extends b {
...
var ContentInjector = class extends BaseComponent {
  ...
  render() {
    ...
    if (hasCustomRenderingHandler(props.generatorName, options)) {
      ...
      const customContent = typeof generator === "function" ? generator(renderProps, y) : generator;
      if (typeof customContent === "string" || t(customContent) || Array.isArray(customContent)) {
...
var ContentContainer = class extends b {
  constructor() {
    super(...arguments);
...
function InnerContentInjector(containerComponent, props) {
  ...
  return y(ContentInjector, Object.assign({ renderProps: parentProps.renderProps, generatorName: parentProps.generatorName, generator: parentProps.generator, renderId: containerComponent.context }, props));
}
...
var TableDateCell = class extends BaseComponent {
  render() {
    ...
    return y(ContentContainer, { elTag: "th", elClasses: classNames, elAttrs: Object.assign({ role: "columnheader", colSpan: props.colSpan, "data-date": !dayMeta.isDisabled ? formatDayString(date) : void 0 }, props.extraDataAttrs), renderProps, generatorName: "dayHeaderContent", generator: options.dayHeaderContent || renderInner$1, classNameGenerator: options.dayHeaderClassNames, didMount: options.dayHeaderDidMount, willUnmount: options.dayHeaderWillUnmount }, (InnerContainer) => y("div", { className: "fc-scrollgrid-sync-inner" }, !dayMeta.isDisabled && y(InnerContainer, { elTag: "a", elAttrs: navLinkAttrs, elClasses: [
...
var TableDowCell = class extends BaseComponent {
  render() {
    ...
    ], elAttrs: Object.assign({ role: "columnheader", colSpan: props.colSpan }, props.extraDataAttrs), renderProps, generatorName: "dayHeaderContent", generator: options.dayHeaderContent || renderInner$1, classNameGenerator: options.dayHeaderClassNames, didMount: options.dayHeaderDidMount, willUnmount: options.dayHeaderWillUnmount }, (InnerContent) => y(
      "div",
...
var SimpleScrollGrid = class extends BaseComponent {
  ...
  renderSection(sectionConfig, microColGroupNode, isHeader) {
    if ("outerContent" in sectionConfig) {
      return y(g, { key: sectionConfig.key }, sectionConfig.outerContent);
    }
...
function renderInnerContent$1(innerProps) {
  return y(
    ...
    y(
      ...
      y("div", { className: "fc-event-title fc-sticky" }, innerProps.event.title || y(g, null, " "))
    )
  );
}
var NowIndicatorContainer = (props) => y(ViewContextType.Consumer, null, (context) => {
  ...
  return y(ContentContainer, Object.assign({}, props, { elTag: props.elTag || "div", renderProps, generatorName: "nowIndicatorContent", generator: options.nowIndicatorContent, classNameGenerator: options.nowIndicatorClassNames, didMount: options.nowIndicatorDidMount, willUnmount: options.nowIndicatorWillUnmount }));
});
  ...
  constructor(el, optionOverrides = {}) {
    ...
    this.handleRenderRequest = () => {
      if (this.isRendering) {
        ...
        flushSync(() => {
          q(y(CalendarRoot, { options: currentData.calendarOptions, theme: currentData.theme, emitter: currentData.emitter }, (classNames, height, isHeightAuto, forPrint) => {
...
//# sourceMappingURL=chunk-FMYHF2SG.js.map
