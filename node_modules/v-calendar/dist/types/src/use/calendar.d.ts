...
import { type DateSource } from 'v-calendar/dist/types/src/utils/date/helpers';
import { type DateRangeCell, DateRangeContext } from 'v-calendar/dist/types/src/utils/date/range';
import { type CalendarDay, type CalendarWeek, type Page, type PageAddress, type TitlePosition } from 'v-calendar/dist/types/src/utils/page';
...
export declare const propsDef: {
    ...
    firstDayOfWeek: PropType<import("v-calendar/dist/types/src/utils/date/helpers").DayOfWeek>;
    masks: ObjectConstructor;
    locale: PropType<string | import("v-calendar/dist/types/src/utils/locale").default | Record<string, any>>;
...
export declare function createCalendar(props: CalendarProps, { slots, emit }: Pick<SetupContext, 'slots' | 'emit'>): {
    ...
    focusedDay: import("vue").Ref<{
        ...
        locale: {
            ...
            toDate: (d: Partial<import("v-calendar/dist/types/src/utils/date/helpers").SimpleDateParts> | DateSource, opts?: Partial<import("v-calendar/dist/types/src/utils/date/helpers").DateOptions>) => Date;
            toDateOrNull: (d: Partial<import("v-calendar/dist/types/src/utils/date/helpers").SimpleDateParts> | DateSource, opts?: Partial<import("v-calendar/dist/types/src/utils/date/helpers").DateOptions>) => Date | null;
            ...
            getPage: (config: import("v-calendar/dist/types/src/utils/page").PageConfig) => Page;
