...
function TimeColsAxisCell(props) {
  ...
  return y(ViewContextType.Consumer, null, (context) => {
    ...
    }, renderProps, generatorName: "slotLabelContent", generator: options.slotLabelContent || renderInnerContent, classNameGenerator: options.slotLabelClassNames, didMount: options.slotLabelDidMount, willUnmount: options.slotLabelWillUnmount }, (InnerContent) => y(
      "div",
    ...
    this.renderTableRowAxis = (rowHeight) => {
      ...
      return (
        ...
        y(ContentContainer, { elTag: "td", elClasses: [
          ...
          "aria-hidden": true
        }, renderProps, generatorName: "allDayContent", generator: options.allDayContent || renderAllDayInner, classNameGenerator: options.allDayClassNames, didMount: options.allDayDidMount, willUnmount: options.allDayWillUnmount }, (InnerContent) => y(
          "div",
          { className: [
            "fc-timegrid-axis-frame",
            "fc-scrollgrid-shrink-frame",
...
var TimeCol = class extends BaseComponent {
  ...
  renderHiddenGroups(hiddenGroups, segs) {
    ...
    return y(g, null, hiddenGroups.map((hiddenGroup) => {
...
function renderPlainFgSegs(sortedFgSegs, { todayRange, nowDate, eventSelection, eventDrag, eventResize }) {
  ...
  return y(g, null, sortedFgSegs.map((seg) => {
    let instanceId = seg.eventRange.instance.instanceId;
    return y(
      "div",
